...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col sm:flex-row sm:justify-center gap-3 mt-4",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(buttonVariants({ variant: "default" }), "h-12 rounded-xl px-8 font-bold", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      "h-12 rounded-xl px-8 font-bold mt-2 sm:mt-0",
      className
    )}
    {...props}
  />
